...
async def analyze(request: Request):
    ...
    while main_loop < 3:
        try:
            ...
            python_exec = sys.executable  # pick next venv
...
if __name__ == "__main__":
    import uvicorn
    # This block will only run when you execute "python main.py" directly
    # It will NOT run on Railway, as Railway uses the Procfile command
